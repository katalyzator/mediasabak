...
!function (a, b, c, d) {
    ...
    a.quiz = function (b, d) {
        ...
        var f = e.options.questions, g = f.length, h = e.options.startScreen, i = e.options.startButton,
            j = e.options.homeButton, k = e.options.resultsScreen, l = e.options.gameOverScreen,
            m = e.options.nextButtonText, n = e.options.finishButtonText, o = e.options.restartButtonText, p = 1, q = 0,
            r = !1;
        e.methods = {
            init: function () {
                ...
                if (!r) {
                    r = !0;
                    var c = a(b), d = "", g = c.data("index"), h = p - 1, i = f[h].correctIndex;
                    if (g === i) c.addClass("correct"), d = f[h].correctResponse, q++; else if (c.addClass("incorrect"), d = f[h].incorrectResponse, !e.options.allowIncorrect)return void e.methods.gameOver(d);
                    a("#quiz-response").html(d), a("#quiz-controls").fadeIn(), "function" == typeof e.options.answerCallback && e.options.answerCallback(p, g === i)
                }
        ...
        resultsFormat: "Вы ответили правильно на %score вопроса из %total",
        gameOverScreen: "#quiz-gameover-screen",
        nextButtonText: "Далее",
        finishButtonText: "Закончить",
        restartButtonText: "Пройти тест снова"
